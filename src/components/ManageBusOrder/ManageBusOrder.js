...
const ManageBusOrder = () => {
  ...
  const handleDeleteOrder = (id) => {
    ...
    if (isDelete) {
      axios
        .post("https://infinite-reaches-98033.herokuapp.com/deleteOrder", {
          UserId: id,
        })
        .then((res) => {
  ...
  const handleUpdateStatus = (e) => {
    ...
    axios
      .post("https://infinite-reaches-98033.herokuapp.com/updateStatus", {
        status: status,
        id: id,
      })
  ...
  useEffect(() => {
    axios
      .get("https://infinite-reaches-98033.herokuapp.com/manageBus")
