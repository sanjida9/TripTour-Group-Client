      ...
      <div class="min-h-screen flex">
          ...
          <div class="flex space-2 items-center pb-4">
            <div class="ml-3">
              <NavLink aria-current="page" class="active" to="/">
                ...
                <h1 class="text-3xl font-bold text-white">TripTour</h1>
              </NavLink>
            </div>
          </div>
          <hr />
        ...
        <div class="bg-indigo-50 flex-grow py-12 px-10">
          <Switch>
            ...
            <AdminRoute path={`${path}/manageFlights`}>
              <ManageFlightOrder></ManageFlightOrder>
            </AdminRoute>
